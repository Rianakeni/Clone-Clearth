            ...
            <div className="logo-container">
                ...
                <div className='transparent-container'>
                    ...
                    <div>
                        ...
                        <h3 className='tempattext'><strong>Alamat:</strong>{data.tempatSampahE.alamat}</h3>
                        <h3 className='tempattext'><strong>Deskripsi:</strong>{data.tempatSampahE.deskripsi}</h3>
                    </div>
                </div>
            </div>
